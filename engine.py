...
def main():
    ...
    panel=lc.console_new(constants['screen_width'],constants['panel_height'])
    ...
    while not lc.console_is_window_closed():
        ...
        if show_main_menu:
            ...
            if show_load_error_message:
                message_box(con,'No save game.',50,constants['screen_width'],constants['screen_height'])
            lc.console_flush()
    ...
    while not lc.console_is_window_closed():
        ...
        if move and game_state==GameStates.PLAYER_TURN:
            ...
            for entity in entities:
                ...
                message_log.add_message(Message('There is nothing here to pick up.',lc.yellow))
        ...
        if take_stairs and game_state==GameStates.PLAYER_TURN:
            for entity in entities:
                ...
                message_log.add_message(Message('There are no stairs here.',lc.yellow))
        ...
        if exit:
            if game_state in (GameStates.SHOW_INVENTORY,GameStates.DROP_INVENTORY,GameStates.CHARACTER_SCREEN):
                ...
                if not game_state==GameStates.PLAYER_DEAD:
                    ...
                    json_save_game(player,entities,game_map,message_log,game_state,con,constants['screen_width'],constants['screen_height']) #Takes about 15 times longer
                return True
        ...
        for result in player_turn_results:
            ...
            if xp:
                ...
                if leveled_up:
                    message_log.add_message(Message('Your battle skills grow stronger! You reached level {0}'.format(player.level.current_level)+'!',lc.yellow))
                    previous_game_state=game_state
